...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcShowpass.setFont(new java.awt.Font("Calibri", 1, 12)); // NOI18N
        jcShowpass.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if("admin".equals(tfUsername.getText())){
           if("admin".equals(tfPassword.getText())){
               FormAplikasiBukuAlamat FormHari = new FormAplikasiBukuAlamat();
